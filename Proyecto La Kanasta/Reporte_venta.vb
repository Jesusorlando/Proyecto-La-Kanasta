Public Class Reporte_venta
    ...
    Public Sub MostrarDatos()
        conexion.Consulta($" select v.idVenta as 'Venta', fecha as 'Fecha', idProducto as 'Producto', Cantidad, total  from Venta2 v , ProductosVenta pv where v.idVenta = pv.IdVenta AND fecha between '{txtInicio.Text}' and '{txtFin.Text}' AND NOT total is NULL", "ReporteVenta")
